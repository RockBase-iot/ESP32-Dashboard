...
public:
    ...
    uint16_t      colorHighlight()    const override { return GxEPD_WHITE; }
    ...
    uint32_t readBatteryMv() override {
        // No enable pin on this board — the divider is always connected. Still
        // configure the ADC explicitly and average, exactly like the NM boards.

...
void test_configurable_idle_threshold_defers_deep_sleep() {
    WakeCoordinator coordinator;
    WakeInputs input;
    input.currentState = PowerState::Interactive;
    input.signal = WakeSignal::Inactivity;
    input.secondsSinceActivity = 59;
    input.interactiveIdleSeconds = 60;
...
void setup() {
    ...
    RUN_TEST(test_configurable_idle_threshold_defers_deep_sleep);
